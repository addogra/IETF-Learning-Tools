...
- `src/ietf_wg_agent/cli.py`
  - interactive iterative onboarding for `REQ-FEAT-001..005`
...
## Diagrams
- REQ-FEAT-001..005 architecture (PlantUML source + SVG):
